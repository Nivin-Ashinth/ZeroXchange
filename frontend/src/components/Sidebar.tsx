...
import { Layout, BarChart2, Star, Settings, LogOut, ArrowRightLeft } from 'lucide-react';
    ...
    <div className="w-16 bg-gray-900 min-h-screen flex flex-col items-center py-8 gap-8">
      ...
      <nav className="flex flex-col gap-6">
        ...
        <button 
          ...
          className={`p-2 rounded-lg transition-colors ${
            isActive('/transactions') ? 'bg-blue-500 text-white' : 'text-gray-500 hover:text-gray-300'
          }`}
        >
