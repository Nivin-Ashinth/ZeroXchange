...
import (
	...
	"github.com/Vpragadeesh/privchain/app"
)
...
// genesisCommand builds genesis-related `privchaind genesis` command. Users may provide application specific commands as a parameter
